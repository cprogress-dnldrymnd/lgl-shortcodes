					...
					<div class="bt-table--head">
						<div class="bt-table--row">
							<div class="bt-table--col bt-car-remove">
								<?php echo '<span>' . __('Remove', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-thumb">
								<?php echo '<span>' . __('Thumbnail', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-title">
								<?php echo '<span>' . __('Car Name', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-price">
								<?php echo '<span>' . __('Price', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-stock">
								<?php echo '<span>' . __('Status', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-seller">
								<?php echo '<span>' . __('Seller', 'clwyd') . '</span>'; ?>
							</div>
						</div>
					</div>
						...
						<div class="bt-car-list">
								...
								<?php foreach ($car_ids as $key => $id) { ?>
									<div class="bt-table--row bt-car-item">
										...
										<div class="bt-table--col bt-car-seller">
											...
											if (!empty($dealer)) {
												echo '<a href="' . get_the_permalink($dealer) . '" class="bt-seller-btn">' . __('Contact', 'clwyd') . '</a>';
											} else {
												echo '<a href="/contact-us/" class="bt-seller-btn">' . __('Contact', 'clwyd') . '</a>';
											}
											?>
										</div>
									</div>
							...
							<?php } else { ?>
								<div class="bt-no-results">
									<?php echo __('Post not found!', 'clwyd'); ?>
									<a href="/cars/">
										<?php echo __('Back To All Cars', 'clwyd'); ?>
									</a>
								</div>
							<?php } ?>
						</div>
