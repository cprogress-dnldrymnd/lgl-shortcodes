...
class Widget_CarsQuickCompare extends Widget_Base
{
	...
	{
		return __('Cars Quick Compare', 'clwyd');
	}
...
{
  if (empty($post_id)) {
    echo '<h3 class="bt-not-found">' . __('Please, Add car to compare!', 'clwyd') . '</h3>';
    return;
  }
    ...
    <div class="bt-post--price">
      <?php
        if (!empty($price)) {
          ...
          echo '<a href="#">' . esc_html__('Call for price', 'clwyd') . '</a>';
        }
      ?>
    </div>
      ...
      <div class="bt-post--meta-row">
        ...
        <div class="bt-post--meta-col">
          <div class="bt-post--meta-item bt-post--fuel-type">
            ...
            <?php
              echo '<span class="bt-label">' . esc_html__('Berth', 'clwyd') . '</span>';

              if (!empty($berth_terms) && !is_wp_error($berth_terms)) {
                $term = array_pop($berth_terms);
                echo '<span class="bt-value">' . esc_html($term->name) . '</span>';
              } else {
                echo '<span class="bt-value">' . esc_html__('N/A', 'clwyd') . '</span>';
              }
            ?>
          </div>
        </div>
        ...
        <div class="bt-post--meta-col">
          <div class="bt-post--meta-item bt-post--mileage">
            ...
            <?php
              echo '<span class="bt-label">' . esc_html__('Year', 'clwyd') . '</span>';
  ...
  <?php
	...
	public function post_social_share()
	{
		...
		$social_item = array();
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-facebook" data-toggle="tooltip" title="' . esc_attr__('Facebook', 'clwyd') . '" href="https://www.facebook.com/sharer/sharer.php?u=' . get_the_permalink() . '">
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-twitter" data-toggle="tooltip" title="' . esc_attr__('Twitter', 'clwyd') . '" href="https://twitter.com/share?url=' . get_the_permalink() . '">
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-google-plus" data-toggle="tooltip" title="' . esc_attr__('Google Plus', 'clwyd') . '" href="https://plus.google.com/share?url=' . get_the_permalink() . '">
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-linkedin" data-toggle="tooltip" title="' . esc_attr__('Linkedin', 'clwyd') . '" href="https://www.linkedin.com/shareArticle?url=' . get_the_permalink() . '">
		...
		$social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-pinterest" data-toggle="tooltip" title="' . esc_attr__('Pinterest', 'clwyd') . '" href="https://pinterest.com/pin/create/button/?url=' . get_the_permalink() . '">
	...
	?>
		<div class="bt-post-share">
			...
			if (!empty($social_item)) {
				echo '<span>' . esc_html__('Share: ', 'clwyd') . '</span><ul>' . implode(' ', $social_item) . '</ul>';
			}
			?>
		</div>
	<?php
	...
	{
		if (empty($car_ids)) {
			echo '<h3 class="bt-not-found">' . __('Please, Add cars to compare!', 'clwyd') . '</h3>';
					...
					<div class="bt-table--head">
						<div class="bt-table--row">
							<div class="bt-table--col bt-car-information">
								<?php echo '<span>' . __('Information', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-body">
								<?php echo '<span class="bt-label">' . __('Body', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-berth">
                              <?php echo '<span class="bt-label">' . __('Berth', 'clwyd') . '</span>'; ?>
                            </div>
							<div class="bt-table--col bt-car-condition">
								<?php echo '<span class="bt-label">' . __('Condition', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-mileage">
								<?php echo '<span class="bt-label">' . __('Mileage', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-engine-size">
								<?php echo '<span class="bt-label">' . __('Engine Size', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-fuel-type">
								<?php echo '<span class="bt-label">' . __('Fuel Type', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-door">
								<?php echo '<span class="bt-label">' . __('Door', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-year">
								<?php echo '<span class="bt-label">' . __('Year', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-cylinder">
								<?php echo '<span class="bt-label">' . __('Cylinder', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-transmission">
								<?php echo '<span class="bt-label">' . __('Transmission', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-color">
								<?php echo '<span class="bt-label">' . __('Color', 'clwyd') . '</span>'; ?>
							</div>
							<div class="bt-table--col bt-car-features">
								<?php echo '<span class="bt-label">' . __('Features', 'clwyd') . '</span>'; ?>
							</div>
						</div>
					</div>
								...
								<div class="bt-table--row bt-car-item">
									...
									<div class="bt-table--col bt-car-mileage">
										<?php
											...
											if(!empty($mileage)) {
												echo '<span class="bt-value">' . number_format($mileage, 0) . esc_html__(' km', 'clwyd') . '</span>';
											} else {
												echo '<span class="bt-value">' . esc_html__('N/A', 'clwyd') . '</span>';
											}
										?>
										...
										?>
											<div class="bt-table--row bt-car-item">
												<div class="bt-table--col bt-car-add-compare">
													...
													<h3 class="bt-car-title">
														<a href="/cars/">
															<?php echo __('Add Car To Compare', 'clwyd'); ?>
														</a>
													</h3>
												</div>
				...
				<div class="bt-cars-quick-compare--inner">
					<div class="bt-cars">
						...
						<div class="bt-cars--divider">
							<?php echo '<span>' . __('vs', 'clwyd') . '</span>'; ?>
						</div>
					...
					<div class="bt-cars--compare">
						<a class="bt-quick-compare-btn" href="#">
							<span><?php echo __('Compare Now', 'clwyd'); ?></span>
