...
// Routing Extraction (IDs to Permalinks)
...
<div class="lgl-finance-specialist-wrapper">
    <div class="lgl-finance-content">
        ...
        <div class="lgl-finance-slider-container">
            <input type="range" class="lgl-budget-slider" min="1000" max="100000" step="500" value="25000">
            <p class="lgl-finance-max-price">Max vehicle price <strong>£<span class="lgl-slider-output">25,000</span></strong></p>
        </div>
